...
namespace NodeHDF5 {
    ...
    class Int32Array : public node::ObjectWrap {
    private:
...
//        std::cout<<"New  "<<args[0]->ToUint32()->IntegerValue()<<std::endl;
                Int32Array* array = new Int32Array(args[0]->ToUint32()->IntegerValue());
        ...
        ArrayBuffer* buf = ObjectWrap::Unwrap<ArrayBuffer>(args[0]->ToObject());
               Int32Array* array = new Int32Array(buf->length/4);
                array->Wrap(args.This());
            
        }
//    std::cout<<"old Int32Array New "<<std::endl;
                return args.This();
            }
    public:
    Int32Array(unsigned long long length): length (length), buffer(new int[length]) {
    }
...
//        std::cout<<"created  "<<std::endl;
    ...
    static Handle<v8::Value> NewInstance(const v8::Arguments& args){
        ...
        Int32Array* pThis = node::ObjectWrap::Unwrap<Int32Array>(instance);
    ...
    static v8::Handle<v8::Value> get (const v8::Arguments& args) {
        ...
        // unwrap array
        Int32Array* array = Int32Array::Unwrap<Int32Array>(args.This());
    ...
    static v8::Handle<v8::Value> slice (const v8::Arguments& args) {
        ...
        Local<Object> slice=Int32Array::Instantiate(ArrayBuffer::Instantiate(std::max((unsigned long)0, end-begin-1)));
        Int32Array* pThis = node::ObjectWrap::Unwrap<Int32Array>(slice);
        slice->SetIndexedPropertiesToExternalArrayData((void * )pThis->buffer.get(), v8::kExternalIntArray, (int)pThis->length);
...
//        pThis->arrayBuffer.buffer=ArrayBuffer::Instantiate(4*size);
        instance->SetIndexedPropertiesToExternalArrayData((void * )pThis->buffer.get(), v8::kExternalIntArray, (int)pThis->length);
...
//        pThis->arrayBuffer.buffer=ArrayBuffer::Instantiate(4*size);
        ...
        instance->SetIndexedPropertiesToExternalArrayData((void * )pArrayBuffer->buffer.get(), v8::kExternalIntArray, (int)pThis->length);
    ...
    Persistent<FunctionTemplate> Int32Array::Constructor;
}